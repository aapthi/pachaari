<?php
class EM_Em0075settings_Helper_Sample extends Mage_Core_Helper_Abstract
{
	protected $_themeSlug  = 'default/em0075';
	...
	protected $_megaMenuModel = 'em0075settings/megamenupro';
