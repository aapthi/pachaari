<?php
class EM_Em0075settings_Adminhtml_Em0075settings_LinkController extends Mage_Adminhtml_Controller_Action
{
	...
	public function userguideAction() {
		$this->getResponse()->setRedirect('http://www.emthemes.com/documentation/em0075-userguide/');
	}
